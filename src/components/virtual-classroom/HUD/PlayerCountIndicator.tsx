...
export function PlayerCountIndicator({ playerCount, isConnected }: Props) {
  return (
    <div className="absolute right-3 bottom-24 z-20 flex items-center gap-2 rounded-xl bg-white/90 px-3 py-2 shadow-lg ring-1 ring-slate-200 backdrop-blur sm:bottom-3">
